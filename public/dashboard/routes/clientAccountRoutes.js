...
// Endpoint: Register a client account (already exists)
router.post('/register', async (req, res) => {
  try {
    ...
    const folder = await require('../models/ClientFolder').findOne({ slug: folderSlug });
    if (!folder) {
